...
export default function CreateUser({ roles, permissions }: { roles: string[]; permissions: string[] }) {
        ...
        <>
            ...
            <div className="space-y-6 p-4">
                <div className="flex flex-col justify-between gap-3 md:flex-row md:items-center">
                    <Heading title="Create user" description="Assign roles first. Direct permissions are for rare exceptions." />
                    <Button asChild variant="outline"><Link href="/users">Back</Link></Button>
                </div>

                {!auth.can?.userAssignPermission ? (
                    <Alert>
                        <AlertTitle>Role-first access</AlertTitle>
                        <AlertDescription>This screen follows Spatie best practice: roles carry permissions, users carry roles.</AlertDescription>
                    </Alert>
                ) : null}
                ...
                <form onSubmit={submit} className="grid gap-6 lg:grid-cols-3">
                    <Card className="rounded-lg lg:col-span-2">
                        <CardHeader>
                            ...
                            <CardDescription>Basic login details.</CardDescription>
                        </CardHeader>
                    ...
                    <Card className="rounded-lg">
                        <CardHeader>
                            ...
                            <CardDescription>Required primary access groups.</CardDescription>
                        </CardHeader>
                    ...
                    {auth.can?.userAssignPermission ? (
                        <Card className="rounded-lg lg:col-span-3">
                            <CardHeader>
                                ...
                                <CardDescription>Optional exceptions. Removing a permission here blocks access immediately unless a role still grants it.</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-3">
