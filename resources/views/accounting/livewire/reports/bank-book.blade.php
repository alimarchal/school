<div>
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
        ...
        <div><x-accounting::label for="bank_account_id" value="Bank Account" />
            <select id="bank_account_id" wire:model.live="bank_account_id" class="border-gray-300 rounded-md shadow-sm block mt-1 w-full">
